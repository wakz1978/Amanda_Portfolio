...
employees_df <- read.csv('../Datasets/employees.csv', stringsAsFactors = T)
survey_dict <- read.csv('../Datasets/Dictionary.csv', header = FALSE, col.names = c('SurveyQuestion', 'QuestionDetail'))
...
library(writexl)
write_xlsx(highincome_nostock,'../Datasets/HighIncomeNoStock.xlsx')
